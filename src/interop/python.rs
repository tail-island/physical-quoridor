...
impl PhysicalQuoridor {
    ...
    fn new(seed: u64) -> PhysicalQuoridor {
        PhysicalQuoridor {
            game: crate::PhysicalQuoridor::new(seed)
        }
    }

    fn step(&mut self, actions: [(i32, (f32, f32), (i32, i32, i32)); 2]) -> ([crate::Observation; 2], [f32; 2], [bool; 2]) {
        self.game.step(actions.map(|action|
            match action.0 {
